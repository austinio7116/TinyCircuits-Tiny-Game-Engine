...
{
#ifdef DOOM_THUMBY
    /* Thumby: convert palette-indexed I_VideoBuffer directly to
     * engine's active_screen_buffer (RGB565). No intermediate buffer. */
    extern uint16_t *active_screen_buffer;
    if (!active_screen_buffer) { DG_DrawFrame(); return; }
...
void I_SetPalette (byte* palette)
{
    ...
    for (i=0; i<256; ++i ) {
        ...
        /* Pre-compute RGB565 palette for direct framebuffer rendering */
