...
# firmware_date.h is normally generated by build_and_upload.py for
# standalone TinyCircuits-style engine builds. ThumbyOne and other
# CMake-driven builds don't run that script, so generate a stub here
# the first time CMake configures if the header isn't already present.
# The stub's values don't matter for ThumbyOne — SYSTEM_FILES_DIGEST is
# only consulted by the stock launcher's "system files out of sync"
# detection, which ThumbyOne replaces with a ROM-backed /system mount.
# build_and_upload.py-style runs overwrite this file with real values
# before invoking CMake, so this guard never clobbers their work.
if(NOT EXISTS "${ENGINE_MOD_DIR}/firmware_date.h")
    file(WRITE "${ENGINE_MOD_DIR}/firmware_date.h"
"#ifndef FIRMWARE_DATE_H\n\
#define FIRMWARE_DATE_H\n\
\n\
/* Stub generated by src/micropython.cmake at configure time. */\n\
/* Overwritten by build_and_upload.py for standalone engine builds. */\n\
#define FIRMWARE_DATE \"thumbyone-build\"\n\
#define SYSTEM_FILES_DIGEST (0ull)\n\
\n\
#endif\n")
endif()
...
target_sources(usermod_engine INTERFACE
    ...
    ${ENGINE_MOD_DIR}/fault/engine_trace_portable.c
